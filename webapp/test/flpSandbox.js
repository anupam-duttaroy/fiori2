		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample Test",
									"targetURL": "#demoproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoproject1-display": {
								"semanticObject": "demoproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demoproject1",
									"url": sap.ui.require.toUrl("demoproject1")
								}
							}
						}
					}
